...
fig.savefig("ESP32_NumMessages_LengthDutyCycle.png", bbox_inches='tight')
plt.show()
plt.clf()
...
fig, ax = plt.subplots(figsize=(12, 4))
plt.ylim([0,1.5])
df[["Num Messages", "Charge (mAh)"]].plot(x="Num Messages", y="Charge (mAh)", ax=ax, legend=None, marker='o')
...
fig.savefig("ESP32_NumMessages_ChargemAh.png", bbox_inches='tight')
plt.show()
plt.clf()
