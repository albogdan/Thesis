...
String CloudIoTCoreDevice::getCommandTopic()
{
  return String("/devices/") + device_id + "/commands";
}
...
String CloudIoTCoreDevice::getTopic1()
{
  return String("/devices/") + device_id + "/events/topic_1";
}

String CloudIoTCoreDevice::getConfigurationTopic()
{
  return String("projects/") + device_id + "/subscriptions/config-sub";
}
