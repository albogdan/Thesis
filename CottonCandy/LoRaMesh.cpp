...
void LoRaMesh::preDataCollectionCallback(void(*callback)()) {
  myEngine->preDataCollectionCallback(callback);
}
void LoRaMesh::postDataCollectionCallback(void(*callback)()) {
  myEngine->postDataCollectionCallback(callback);
}
